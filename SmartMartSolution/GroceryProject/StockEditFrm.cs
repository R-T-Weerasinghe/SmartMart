...
namespace Esoft_last_project
{
    public partial class StockEditFrm : Form
    {
        ...
        {
            StaffStockViewFrm StaffStockView = new StaffStockViewFrm();
            StaffStockView.Show();
            this.Close();
        }
        ...
        {
            StaffQuickViewFrm QuickView = new StaffQuickViewFrm();
            QuickView.Show();          
        }
        ...
        private void ImportBtn_Click(object sender, EventArgs e)
        {
            ...
            path = path.Remove(0,1);   //0=start index ~ 1=count(how many chars will be removed)
            int count = path.Length;
            path = path.Remove(count-1,1);
        ...
        private void PrizeTxt_TextChanged(object sender, EventArgs e)
        {
        }
